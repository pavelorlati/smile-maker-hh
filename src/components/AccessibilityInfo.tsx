...
const AccessibilityInfo = () => {
  ...
  return (
    <>
      ...
      <div className="<div className="fixed left-4 bottom-6 z-50 flex flex-col-reverse sm:flex-row items-start sm:items-end gap-3"> flex flex-col-reverse sm:flex-row items-start sm:items-end gap-3">
        <button
